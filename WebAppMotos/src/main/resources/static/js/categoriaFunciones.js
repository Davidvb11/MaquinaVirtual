...
function ctgrPost(){
	...
	$.ajax({    
		url:'http://193.123.102.29/api/Category/save',
		type : 'POST',
		data: datosJson,
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function ctgrEdit (id){
	$.ajax({    
		url : 'http://193.123.102.29/api/Category/'+id,
		type : 'GET',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://193.123.102.29/api/Category/"+id);
        let miTabla = '<table>';
			$("#id").val(respuesta.id);
...
function ctgrPut(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax({    
		url : 'http://193.123.102.29/api/Category/update',
		data: datosJson,
		type : 'PUT',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function ctgrDelete(idCtgr){
	...
	$.ajax({    
		url : 'http://193.123.102.29/api/Category/'+idCtgr,
		data: "{}",
		type : 'DELETE',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
