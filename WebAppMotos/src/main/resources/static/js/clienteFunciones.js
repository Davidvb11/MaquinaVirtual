...
function clientePost(){
	...
	$.ajax({    
		url:'http://193.123.102.29/api/Client/save',
		type : 'POST',
		data: datosJson,
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function clienteEdit (id){
	$.ajax({    
		url : 'http://193.123.102.29/api/Client/'+id,
		type : 'GET',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://193.123.102.29/api/Client/"+id);
        let miTabla = '<table>';
...
function clientePut(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax({    
		url : 'http://193.123.102.29/api/Client/update',
		data: datosJson,
		type : 'PUT',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function clienteDelete(idcliente){
	...
	$.ajax({    
		url : 'http://193.123.102.29/api/Client/'+idcliente,
		data: "{}",
		type : 'DELETE',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
