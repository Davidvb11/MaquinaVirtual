...
function msjGet(){
	$.ajax({    
		url : 'http://193.123.102.29/api/Message/all',
		type : 'GET',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function msjPost(){
	...
	if (selected > 0){
		...
		$.ajax({    
			url:'http://193.123.102.29/api/Message/save',
			type : 'POST',
			data: datosJson,
			dataType : 'json',
			contentType: "application/json; charset=utf-8",
...
function msjEdit (id){
	$.ajax({    
		url : 'http://193.123.102.29/api/Message/'+id,
		type : 'GET',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://193.123.102.29/api/Message/"+id);
        let miTabla = '<table>';
...
function msjPut(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax({    
		url : 'http://193.123.102.29/api/Message/update',
		data: datosJson,
		type : 'PUT',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function msjDelete(idMsj){
	...
	$.ajax({    
		url : 'http://193.123.102.29/api/Message/'+idMsj,
		data: "{}",
		type : 'DELETE',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
