function printSelect(){
	$.ajax({    
		url : 'http://193.123.102.29/api/Category/all',
		type : 'GET',
		dataType : 'json',
...
function motoPost(){
	...
	if (selected > 0){
		...
		$.ajax({    
			url:'http://193.123.102.29/api/Motorbike/save',
			type : 'POST',
			data: datosJson,
			dataType : 'json',
			contentType: "application/json; charset=utf-8",
...
function motoEdit (id){
	$.ajax({    
		url : 'http://193.123.102.29/api/Motorbike/'+id,
		type : 'GET',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://193.123.102.29/api/Motorbike/"+id);
        let miTabla = '<table>';
			$("#id").val(respuesta.id);
...
function motoPut(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax({    
		url : 'http://193.123.102.29/api/Motorbike/update',
		data: datosJson,
		type : 'PUT',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function motoDelete(idMoto){
	...
	$.ajax({    
		url : 'http://193.123.102.29/api/Motorbike/'+idMoto,
		data: "{}",
		type : 'DELETE',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
